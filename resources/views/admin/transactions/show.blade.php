                    ...
                    <div class="flex flex-col gap-y-10">
                        <div>
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">
                                Rp{{ number_format($subscribeTransaction->total_amount, 0, ',', '.') }}</h3>
                        </div>
                        @if ($subscribeTransaction->is_paid)
                            <span class="w-fit py-1 px-3 text-sm font-bold rounded-full bg-green-500 text-white">
                                ACTIVE
                            </span>
                        @else
                            <span class="w-fit py-1 px-3 text-sm font-bold rounded-full bg-orange-500 text-white">
                                PENDING
                            </span>
                        @endif
                        <div>
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">
                                {{ \Carbon\Carbon::parse($subscribeTransaction->created_at)->translatedFormat('d F Y H.i') }}
                            </h3>
                        </div>
                        <div>
